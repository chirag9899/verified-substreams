...
export class Trade extends Message<Trade> {
  ...
  /**
   * @generated from field: bytes order_type = 2;
   */
  ...
  /**
   * @generated from field: bytes currency_address = 4;
   */
  currencyAddress = new Uint8Array(0);

  /**
   * @generated from field: uint64 traded_amount = 5;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "order_type", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "price", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "currency_address", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 5, name: "traded_amount", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
