    ...
    pub mod functions {
        ...
        impl Orderbook {
            const METHOD_ID: [u8; 4] = [253u8, 25u8, 202u8, 200u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Orderbook {
            const NAME: &'static str = "_orderbook";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Orderbook {
