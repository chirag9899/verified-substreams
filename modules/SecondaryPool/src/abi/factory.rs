    ...
    pub mod functions {
        ...
        pub struct Create {
            ...
            pub trade_fee_percentage: substreams::scalar::BigInt,
        }
        impl Create {
            const METHOD_ID: [u8; 4] = [116u8, 220u8, 199u8, 164u8];
            pub fn decode(
                ...
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.security),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.currency),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.min_order_size.clone().to_bytes_be() {
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.trade_fee_percentage.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
