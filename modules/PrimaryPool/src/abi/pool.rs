    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetCurrencyIndex {}
        impl GetCurrencyIndex {
            const METHOD_ID: [u8; 4] = [167u8, 72u8, 139u8, 183u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetCurrencyIndex {
            const NAME: &'static str = "getCurrencyIndex";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetIssueCutoffTime {}
        impl GetIssueCutoffTime {
            const METHOD_ID: [u8; 4] = [241u8, 73u8, 62u8, 225u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetIssueCutoffTime {
            const NAME: &'static str = "getIssueCutoffTime";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetIssueCutoffTime {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetMinimumOrderSize {}
        impl GetMinimumOrderSize {
            const METHOD_ID: [u8; 4] = [100u8, 130u8, 201u8, 211u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetMinimumOrderSize {
            const NAME: &'static str = "getMinimumOrderSize";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetMinimumOrderSize {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetMinimumPrice {}
        impl GetMinimumPrice {
            const METHOD_ID: [u8; 4] = [172u8, 67u8, 22u8, 203u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetMinimumPrice {
            const NAME: &'static str = "getMinimumPrice";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOfferingDocuments {}
        impl GetOfferingDocuments {
            const METHOD_ID: [u8; 4] = [156u8, 14u8, 93u8, 19u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetOfferingDocuments {
            const NAME: &'static str = "getOfferingDocuments";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for GetOfferingDocuments {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetSecurityIndex {}
        impl GetSecurityIndex {
            const METHOD_ID: [u8; 4] = [114u8, 243u8, 130u8, 77u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetSecurityIndex {
            const NAME: &'static str = "getSecurityIndex";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetSecurityIndex {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetSecurityOffered {}
        impl GetSecurityOffered {
            const METHOD_ID: [u8; 4] = [149u8, 201u8, 90u8, 79u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetSecurityOffered {
            const NAME: &'static str = "getSecurityOffered";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        pub struct OpenIssue {
            pub security: Vec<u8>,
            pub minimum_order_size: substreams::scalar::BigInt,
            pub minimum_price: substreams::scalar::BigInt,
            pub currency: Vec<u8>,
            pub security_offered: substreams::scalar::BigInt,
            pub cutoff_time: substreams::scalar::BigInt,
            pub offering_docs: String,
        ...
        impl substreams_ethereum::Event for OpenIssue {
            const NAME: &'static str = "OpenIssue";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
