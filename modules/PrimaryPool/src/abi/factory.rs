    ...
    pub mod functions {
        ...
        impl Create {
            const METHOD_ID: [u8; 4] = [34u8, 54u8, 196u8, 204u8];
            pub fn decode(
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Tuple(
                            vec![
                                ethabi::Token::String(self.factory_pool_params.0.clone()),
                                ethabi::Token::String(self.factory_pool_params.1.clone()),
                                ethabi::Token::Address(ethabi::Address::from_slice(& self
                                .factory_pool_params.2)),
                                ethabi::Token::Address(ethabi::Address::from_slice(& self
                                .factory_pool_params.3)),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .factory_pool_params.4.clone().to_bytes_be() {
                                ...
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .factory_pool_params.5.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .factory_pool_params.6.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .factory_pool_params.7.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .factory_pool_params.8.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),), ethabi::Token::String(self
                                .factory_pool_params.9.clone())
                            ],
                        ),
                    ],
                );
