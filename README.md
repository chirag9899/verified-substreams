# StreamingFast Orders and Trades
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

The code in this repo is for creating streaming order, pricing and trade execution data from liquidity pools on the Verified Network.

## Quick Start (Gitpod)

Use these steps to conveniently open your repository in a Gitpod.

1. First, [clone this repository](https://github.com/verified-network/verified-substreams)
...
First, [clone this repository](https://github.com/verified-network/verified-substreams) and clone it.
